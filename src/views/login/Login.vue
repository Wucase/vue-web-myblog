    ...
    <div class='animated fadeIn login' v-if="showLogin">
      ...
      <el-form :model="loginForm" :rules="LoginRules" ref="loginRef">
        <el-form-item prop="userName">
          <el-input v-model="loginForm.userName" class="userName inputStyle" type="text" placeholder="UserName">
          </el-input>
        </el-form-item>
        <el-form-item prop="passWord">
          <el-input type="password" class="password inputStyle" v-model="loginForm.passWord" placeholder="PassWord">
          </el-input>
        </el-form-item>

        <el-form-item class="verCodeList" :class="{opShow:verCodeSum,noShow:!verCodeSum}" prop="verCode">
          <span>
            <el-input v-model="loginForm.verCode" type="text" placeholder="验证码" class="VerCode  inputStyle"></el-input>
          </span>
          <span class="verImg" ref="verCodeNum">{{verCodeNum}}</span>
        </el-form-item>
        <el-form-item class="verList"
          :class="{animatDown:verCodeSum,noDown:!verCodeSum,verList:statusnoverCodeSum,noverList:!statusnoverCodeSum}">
          <el-button @click="login" class="loginBtn">LOTIN</el-button>
          <el-button @click="register" class="regBtn" :class="{r:registerStyle}">R</el-button>
        </el-form-item>
        <el-form-item>
        ...
        this.$refs.loginRef.validate(async (valid) => {
          if (valid) {
            ...
            if(res.meta.status === 200){
              ...
              this.$message.error(res.meta.msg + ",请先注册")
              this.registerStyle = true
              this.resetForm()
            }
          } else {
